...
export const Instance = {
  ...
  containsPath(filepath: string) {
    // altimate_change start — security: use containsReal to resolve symlinks
    // before checking project boundary. Lexical contains() can be bypassed via
    // symlinks pointing outside the project (CVE-style symlink escape attack).
