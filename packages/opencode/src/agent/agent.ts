...
// Temporarily commented out for benchmark focus — only builder agent active
...
export namespace Agent {
  ...
  const state = Instance.state(async () => {
    ...
    const result: Record<string, Info> = {
      ...
      // altimate_change - temporarily commented out non-builder agents for benchmark focus
      // analyst: { ... },
      // executive: { ... },
      // validator: { ... },
      // migrator: { ... },
