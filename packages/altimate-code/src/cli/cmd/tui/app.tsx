...
function App() {
  ...
  useKeyboard((evt) => {
    if (!Flag.ALTIMATE_CLI_EXPERIMENTAL_DISABLE_COPY_ON_SELECT) return
  ...
  createEffect(() => {
    if (!terminalTitleEnabled() || Flag.ALTIMATE_CLI_DISABLE_TERMINAL_TITLE) return
  ...
  return (
    <box
      ...
      onMouseUp={Flag.ALTIMATE_CLI_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? undefined : () => Selection.copy(renderer, toast)}
    >
      <Switch>
