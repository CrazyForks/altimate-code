...
import type * as SDK from "@altimateai/altimate-code-sdk/v2"
...
export namespace ShareNext {
  ...
  const disabled = process.env["ALTIMATE_CLI_DISABLE_SHARE"] === "true" || process.env["ALTIMATE_CLI_DISABLE_SHARE"] === "1"
