...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/AltimateAI/altimate-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for AltimateAI/altimate-code...\n")
...
console.log("Fetching npm all-time downloads for @altimateai/altimate-code...\n")
const npmDownloads = await fetchNpmDownloads("@altimateai/altimate-code")
